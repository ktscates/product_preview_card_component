...
export default function Home() {
  ...
  return (
    <main >
      ...
      <div className=" bg-cream min-h-screen lg:items-center lg:flex max-w-[1440px] lg:mx-auto flex items-center">
        ...
        <div className="rounded-xl lg:grid lg:grid-cols-2 bg-white lg:h-4/5 lg:w-1/2 mx-auto lg:justify-center w-11/12">
          ...
          <div className=" lg:py-8 lg:space-y-8 lg:mx-12 py-6 px-6 lg:px-0 space-y-4">
      ...
      <div class="text-center text-xs py-2">
        Challenge by <a className="text-link_blue" href="https://www.frontendmentor.io?ref=challenge" target="_blank" rel="noreferrer">Frontend Mentor</a>. 
        Coded by <a className="text-link_blue"  href="https://www.frontendmentor.io/profile/ktscates">Cates Nsengiyumva</a>.
      </div>
